...
export default function StudentDashboard() {
  ...
  return (
    <div>
      <div className="mb-8">
        <p className="text-sm font-medium text-indigo-600">{t('student.portal')}</p>
        <h1 className="mt-1 text-3xl font-bold text-slate-900 dark:text-white">{t('student.welcomeBack')}</h1>
